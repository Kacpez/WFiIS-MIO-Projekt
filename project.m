...
% % % % Tuning FIS using Dice Game Optimization (DGO)
% % Retrieve FIS parameters
% iris_param_vals = getTunableValues(iris_fis, getTunableSettings(iris_fis));
% iris_param_size = size(iris_param_vals);
% wine_param_vals = getTunableValues(wine_fis, getTunableSettings(wine_fis));
% seeds_param_vals = getTunableValues(seeds_fis, getTunableSettings(seeds_fis));
